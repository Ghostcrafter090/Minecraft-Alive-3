...
public class stMainVar {
	...
	public static double get() {
		Player entity = Minecraft.getInstance().player;
		return (entity.getCapability(McaModVariables.PLAYER_VARIABLES_CAPABILITY, null).orElse(new McaModVariables.PlayerVariables())).stMain;
	}
}
