package net.mcreator.mca.world.features.treedecorators;
...
public class BlightTrunkDecorator extends TrunkVineDecorator {
	public static final BlightTrunkDecorator INSTANCE = new BlightTrunkDecorator();
	public static com.mojang.serialization.Codec<BlightTrunkDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("blight_tree_trunk_decorator");
