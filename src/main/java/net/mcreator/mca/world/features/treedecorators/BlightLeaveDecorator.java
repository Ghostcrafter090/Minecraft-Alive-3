...
public class BlightLeaveDecorator extends LeaveVineDecorator {
	public static final BlightLeaveDecorator INSTANCE = new BlightLeaveDecorator();
	public static com.mojang.serialization.Codec<LeaveVineDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("blight_tree_leave_decorator");
