...
execute unless entity @e[tag=dmain,type=marker,scores={timeGet=17950..18050}] run time add 10
execute if entity @e[tag=dmain,type=marker,scores={timeGet=17950..18050}] run time set 18000
function world:bosses/ender/effects.0/4
execute as @e[type=enderman] run function world:bosses/ender/effects.0/5
...
execute if entity @e[tag=dmain,type=marker,scores={atic=8..8}] run function world:bosses/ender/effects.0/10