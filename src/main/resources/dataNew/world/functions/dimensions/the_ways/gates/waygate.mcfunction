...
function world:dimensions/the_ways/gates/waygate.0/0
execute as @a run function world:dimensions/the_ways/gates/waygate.0/1
execute as @e[tag=!notick,name=waywaygate,tag=!loaded,type=marker] run function world:dimensions/the_ways/gates/waygate.0/2
execute as @e[name=waygate,type=marker,scores={gateopen=1..2},limit=5,sort=random] run function world:dimensions/the_ways/gates/waygate.0/3
...
execute as @e[name=waygate,type=marker,scores={gateopen=1..2}] run function world:dimensions/the_ways/gates/waygate.0/5
execute as @e[type=!item,type=!falling_block,name=waywaygate,scores={gateopen=1..2},limit=5,sort=random] run function world:dimensions/the_ways/gates/waygate.0/6
...
execute as @e[type=!item,type=!falling_block,name=waywaygate,scores={gateopen=1..2}] run function world:dimensions/the_ways/gates/waygate.0/8
execute as @e[name=waygate,type=marker,scores={gateopen=1..1}] at @s run scoreboard players set @s gateopen 2
execute at @a run function world:dimensions/the_ways/gates/waygate.0/10
execute as @e[type=!item,type=!falling_block,name=waywaygate,sort=random,limit=1] run function world:dimensions/the_ways/gates/waygate.0/11
