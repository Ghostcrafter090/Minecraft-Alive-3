...
execute at @s as @e[tag=!notick,distance=0..80,scores={GT=10000..}] run data merge entity @s {InLove:600}
execute at @s as @e[tag=!notick,distance=0..80,scores={GT=10001..}] run scoreboard players set @s GT 9000