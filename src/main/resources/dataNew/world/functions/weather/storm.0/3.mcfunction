...
execute if entity @s[scores={wt_done=10..10}] run scoreboard players set @s storm_inta 5291
execute if entity @s[scores={wt_done=10..10}] run scoreboard players set @s storm_intb 214748360
...
execute if entity @s[scores={wt_done=90..}] run scoreboard players operation @s storm_posx -= @s storm_velx
execute if entity @s[scores={wt_done=90..}] run scoreboard players operation @s storm_posz -= @s storm_velz