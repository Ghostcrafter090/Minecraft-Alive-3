    ...
    class main:
        ...
        def playSoundWindow(path, volume, speed, balence, waitBool):
            if ambience.getOutStatus() == 1:
                sound.main.playSound(path.split(";")[1], 4,  volume, speed, balence, waitBool)
            else:
                sound.main.playSound(path.split(";")[0], 2,  volume, speed, balence, 0)
                sound.main.playSound(path.split(";")[1], 3,  volume, speed, balence, waitBool)
