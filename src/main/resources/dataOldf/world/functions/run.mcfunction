...
# Thirst fixer
execute as @a[tag=!spawned] run scoreboard players set @s thirst 30
...
execute in mca:the_blight positioned 0 100 0 as @a[distance=0..3000] unless entity @s[scores={air=..10}] if entity @s[scores={blightExit=-5..}] run scoreboard players remove @s blightExit 1
