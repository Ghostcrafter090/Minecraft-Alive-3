...
# execute in mca:the_ways if entity @e[type=!item,type=!falling_block,name=dmain,scores={pigmenmad=202..202}] as @e[type=minecraft:zombified_piglin,distance=0..] run data modify entity @s AngerTime set value 1000
