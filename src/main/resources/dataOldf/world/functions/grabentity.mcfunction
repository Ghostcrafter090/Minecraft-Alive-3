...
execute if entity @e[name=dmain,type=marker,scores={outindex=0..0}] run scoreboard players operation $listutils.result listutils.out = $length lengthObja
execute if entity @e[name=dmain,type=marker,scores={outindex=0..0}] run scoreboard players add $listutils.result listutils.out 1
...
execute if entity @e[name=dmain,type=marker,scores={outindex=-1..0}] run data modify storage minecraft:entity.location uuid append from entity @s UUID
execute if entity @e[name=dmain,type=marker,scores={outindex=-1..0}] run data modify storage minecraft:entity.location load append from entity @s Pos
