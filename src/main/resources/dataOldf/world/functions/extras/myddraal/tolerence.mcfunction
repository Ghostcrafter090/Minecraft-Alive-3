...
# Main
execute as @e[type=wither_skeleton,tag=Myddraal] at @s as @e[distance=0..40,type=!marker,type=!item,type=!item_frame,type=!wither_skeleton] run scoreboard players add @s myddraalTol 1
execute as @e[type=wither_skeleton,tag=Myddraal] at @s as @e[distance=0..30,type=!marker,type=!item,type=!item_frame,type=!wither_skeleton] run scoreboard players add @s myddraalTol 1
