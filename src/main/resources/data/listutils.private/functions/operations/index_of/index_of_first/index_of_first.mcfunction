...
execute unless score $listutils.function listutils.in matches 0 run run function listutils.private:operations/index_of/index_of_first/index_of_first_/1
