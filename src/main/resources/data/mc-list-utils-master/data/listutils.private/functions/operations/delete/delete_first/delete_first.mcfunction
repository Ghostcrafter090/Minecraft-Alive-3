...
execute unless score $listutils.function listutils.in matches 0 run run function mc-list-utils-master:data/listutils.private/functions/operations/delete/delete_first/delete_first_/1
