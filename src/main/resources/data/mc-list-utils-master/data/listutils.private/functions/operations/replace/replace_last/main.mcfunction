...
execute unless score $listutils.function listutils.in matches 0 run run function mc-list-utils-master:data/listutils.private/functions/operations/replace/replace_last/main_/1
