...
execute unless score $listutils.function listutils.in matches 0 run function mc-list-utils-master:data/listutils.private/functions/operations/index_of/index_of_last/index_of_last_/1
