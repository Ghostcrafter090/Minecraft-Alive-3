...
execute unless entity @e[type=!item,type=!falling_block,scores={airfill=1..1}] run function world:moria/monsters/fire/main_/1
execute as @e[type=!item,type=!falling_block,tag=airfill] run scoreboard players set @s airfill 1
function world:moria/monsters/fire/main_/3
...
execute if entity @a[scores={regu=15..15}] run function world:moria/monsters/fire/main_/5
