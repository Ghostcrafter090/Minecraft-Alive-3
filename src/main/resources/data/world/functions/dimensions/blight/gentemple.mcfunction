...
execute in mca:the_blight positioned 1000 250 0 run summon marker ~ ~ ~ {Silent:1b,Invulnerable:1b,Tags:["witherrosetemple"],CustomName:'{"text":"witherrosetemple"}'}
execute in mca:the_blight positioned 1000 250 0 as @e[type=marker,distance=0..300] at @s run spreadplayers ~ ~ 1 2 false @s
