...
execute in mca:the_blight run function world:dimensions/blight/gentemple_/1
...
execute as @e[tag=witherrosetemple,type=marker] run function world:dimensions/blight/gentemple_/4