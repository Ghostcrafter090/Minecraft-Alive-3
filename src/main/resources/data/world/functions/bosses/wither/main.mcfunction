...
function world:bosses/wither/main_/0
execute as @e[type=item,tag=fire_key_shard] run function world:bosses/wither/main_/1
execute as @e[type=item,tag=fire_key_shard,scores={witherStartTic=1..}] run function world:bosses/wither/main_/2
execute if entity @e[name=dmain,scores={witherBool=1..1}] run function world:bosses/wither/effects
execute as @e[type=item,tag=fire_key_shard] run function world:bosses/wither/main_/4
function world:bosses/wither/main_/5
...
execute as @e[tag=fire_key_spawn_site] run function world:bosses/wither/main_/9
...
execute as @e[type=wither,tag=!vuln,tag=!With] run function world:bosses/wither/main_/18
execute as @e[type=wither,tag=vuln,tag=!vulnN] run function world:bosses/wither/main_/19
execute as @a[nbt={SelectedItem:{id:"mca:fire_key"}}] run function world:bosses/wither/main_/20
...
execute as @e[name=dmain,type=marker] run function world:bosses/wither/main_/23
