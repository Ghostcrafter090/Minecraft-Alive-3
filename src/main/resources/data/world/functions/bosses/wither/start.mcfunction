...
execute as @e[type=item,tag=fire_key_shard] run function world:bosses/wither/start_/0
...
execute unless entity @e[tag=!effectwither] run function world:bosses/wither/start_/4
execute if entity @e[type=item,tag=fire_key_shard,scores={witherStartTic=1000..}] run function world:bosses/wither/start_/5