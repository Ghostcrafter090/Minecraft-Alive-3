...
# Main
execute if entity @a[nbt={SelectedItem:{id:"minecraft:totem_of_undying"}}] unless entity @e[name=dmain,type=marker,scores={stopEnable=1..1}] run function world:bosses/villageraid/enable
