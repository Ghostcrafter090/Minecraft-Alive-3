...
execute as @e[type=item,nbt={Item:{id:"mca:defunct_end_key",Count:1b}}] run function world:bosses/ender/findtemple_/0
...
execute as @e[tag=templeFind] run function world:bosses/ender/findtemple_/3
...
execute as @e[tag=templeFind,type=marker] run function world:bosses/ender/findtemple_/6