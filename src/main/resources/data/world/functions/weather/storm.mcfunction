...
function world:weather/storm_/0
...
execute as @e[name=storm] run function world:weather/storm_/3
...
execute as @e[name=dmain,scores={wt_effect_clock=2..}] run function world:weather/storm_/6
...
execute in minecraft:overworld run function world:weather/storm_/10
execute in the_ways:the_ways run function world:weather/storm_/11
execute as @a if entity @s[scores={wt_tick=100..}] run scoreboard players set @s wt_tick 0
execute as @e[name=storm] run function world:weather/storm_/13