...
function world:effects/stamina_/0
...
function world:effects/stamina_/8
...
execute as @a[scores={streg=1..1}] run function world:effects/stamina_/13
...
execute as @a[scores={stamina=..150}] run function world:effects/stamina_/35
execute as @a[scores={stamina=..100}] run function world:effects/stamina_/36
execute as @a[scores={stamina=..50}] run function world:effects/stamina_/37