...
execute if entity @a[scores={reguz=3..4}] run function world:effects/disease/spreaders/zombiepig_/43
...
execute if entity @a[scores={reguz=3..4}] run function world:effects/disease/spreaders/zombiepig_/46
