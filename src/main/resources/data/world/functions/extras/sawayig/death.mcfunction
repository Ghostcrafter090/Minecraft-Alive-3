...
execute as @e[tag=sawayig,type=wither_skeleton,scores={healthb=200..}] run function world:extras/sawayig/death_/6
execute as @e[scores={healthb=0..}] run function world:extras/sawayig/death_/7
execute as @e[tag=sawayig,type=wither_skeleton,scores={healthb=200..}] run function world:extras/sawayig/death_/8
