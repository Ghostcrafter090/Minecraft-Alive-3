...
function world:extras/enderman/endereffect_/0
execute as @e[type=enderman] run function world:extras/enderman/endereffect_/1
...
execute as @e[type=endermite] run function world:extras/enderman/endereffect_/3