...
execute as @a[tag=!spawned] run function world:run_/1
...
execute if entity @e[type=marker,name=dmain,scores={regu=19..}] run function world:run_/20
...
execute if entity @e[type=marker,name=dmain,scores={atic=19..19}] run function world:run_/40
execute if entity @e[type=marker,name=dmain,scores={blocktb=0..}] run function world:run_/41
...
execute if entity @e[type=marker,name=dmain,scores={blocktc=1..}] run function world:run_/44
...
function world:run_/46
execute if entity @e[type=marker,name=dmain,scores={wmoriatic=..2}] run function world:run_/47
scoreboard players remove @e[type=marker,name=dmain] wmoriatic 1
execute if entity @e[type=marker,name=dmain,scores={systic=..1}] run function world:run_/49
...
execute in mca:the_blight run function world:run_/62
execute as @a[scores={blightExit=1..}] run function world:run_/63
...
execute as @a[scores={blightExit=160..}] run function world:run_/79
...
execute in mca:the_blight run function world:run_/83
execute as @a[scores={blightEnter=1..}] run function world:run_/84
...
execute as @a[scores={blightEnter=160..}] run function world:run_/100