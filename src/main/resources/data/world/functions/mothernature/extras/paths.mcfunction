...
execute if entity @a[scores={path=25..25}] as @e[tag=!notick,type=!item,type=!falling_block] unless entity @s[type=marker] at @s run fill ~ ~-1 ~ ~ ~-1 ~ dirt replace grass_block
