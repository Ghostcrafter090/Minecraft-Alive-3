...
function world:worldload_/0
execute if entity @e[name=dmain,scores={startworldclock=1..1}] run function world:worldload_/1
function world:worldload_/2
...
execute if entity @e[name=dmain,scores={loadCount=3..}] run function world:worldload_/20