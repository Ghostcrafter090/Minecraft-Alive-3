...
execute if entity @a[scores={reguz=3..4}] run function minecraft_alive_strpd:data/world/functions/effects/disease/spreaders/zombievill_/43
...
execute if entity @a[scores={reguz=3..4}] run function minecraft_alive_strpd:data/world/functions/effects/disease/spreaders/zombievill_/46
