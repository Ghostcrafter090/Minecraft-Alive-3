...
function minecraft_alive_strpd:data/world/functions/village/village2_/0
execute as @a run function minecraft_alive_strpd:data/world/functions/village/village2_/1
execute as @e[name=vilf,tag=vil] run function minecraft_alive_strpd:data/world/functions/village/village2_/2
execute as @e[name=vilf2,tag=vil] run function minecraft_alive_strpd:data/world/functions/village/village2_/3
execute as @e[name=vilf3,tag=vil] run function minecraft_alive_strpd:data/world/functions/village/village2_/4
execute as @e[name=village,tag=vil] run function minecraft_alive_strpd:data/world/functions/village/village2_/5
...
execute as @e[name=village,tag=vil] run function minecraft_alive_strpd:data/world/functions/village/village2_/14
...
execute as @e[name=vt1,tag=vil] run function minecraft_alive_strpd:data/world/functions/village/village2_/19
execute as @e[name=vt2,tag=vil] run function minecraft_alive_strpd:data/world/functions/village/village2_/20
execute as @e[name=vt3,tag=vil] run function minecraft_alive_strpd:data/world/functions/village/village2_/21
execute as @e[name=vt4,tag=vil] run function minecraft_alive_strpd:data/world/functions/village/village2_/22
execute as @e[name=village,tag=vil] run function minecraft_alive_strpd:data/world/functions/village/village2_/23
function minecraft_alive_strpd:data/world/functions/village/village2_/24
...
execute as @e[type=villager,tag=!vil,scores={vwl=1..1}] run function minecraft_alive_strpd:data/world/functions/village/village2_/26
execute if entity @a[scores={vreg=29..29}] run scoreboard players add @e[type=villager,tag=!vil,scores={vwl=2..2}] vwlt 1
function minecraft_alive_strpd:data/world/functions/village/village2_/28
...
execute as @e[type=villager,tag=!vil,scores={vwl=2..2,vwlt=93..93}] run function minecraft_alive_strpd:data/world/functions/village/village2_/79
...
execute as @e[name=village,tag=vol] run function minecraft_alive_strpd:data/world/functions/village/village2_/82
