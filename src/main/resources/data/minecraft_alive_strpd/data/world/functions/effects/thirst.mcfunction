...
function minecraft_alive_strpd:data/world/functions/effects/thirst_/0
...
execute as @a[scores={air=..5}] run function minecraft_alive_strpd:data/world/functions/effects/thirst_/9
...
execute as @a[scores={death=1..}] run function minecraft_alive_strpd:data/world/functions/effects/thirst_/13
...
execute as @a[scores={air=..5}] run function minecraft_alive_strpd:data/world/functions/effects/thirst_/23
execute as @a[scores={thirst=..20}] run effect give @s weakness 4 0
execute as @a[scores={thirst=..15}] run function minecraft_alive_strpd:data/world/functions/effects/thirst_/25
execute as @a[scores={thirst=..10}] run function minecraft_alive_strpd:data/world/functions/effects/thirst_/26
execute as @a[scores={thirst=..5}] run function minecraft_alive_strpd:data/world/functions/effects/thirst_/27
execute as @a[scores={thirst=..0}] run effect give @s wither 2 0
execute as @a[scores={thirst=..10,}] run function minecraft_alive_strpd:data/world/functions/effects/thirst_/29
