...
function minecraft_alive_strpd:data/world/functions/village/village_/0
execute as @a run function minecraft_alive_strpd:data/world/functions/village/village_/1
execute as @e[name=vilf,tag=vil] run function minecraft_alive_strpd:data/world/functions/village/village_/2
execute as @e[name=vilf2,tag=vil] run function minecraft_alive_strpd:data/world/functions/village/village_/3
execute as @e[name=vilf3,tag=vil] run function minecraft_alive_strpd:data/world/functions/village/village_/4
execute as @e[name=village,tag=vil] run function minecraft_alive_strpd:data/world/functions/village/village_/5
execute as @e[name=vpol1,tag=vil] at @s if entity @e[type=villager,distance=0..50] run tp @s ~1 ~ ~
execute as @e[name=vpol2,tag=vil] at @s if entity @e[type=villager,distance=0..50] run tp @s ~-1 ~ ~
execute as @e[name=vpol3,tag=vil] at @s if entity @e[type=villager,distance=0..50] run tp @s ~ ~ ~1
execute as @e[name=vpol4,tag=vil] at @s if entity @e[type=villager,distance=0..50] run tp @s ~ ~ ~-1
execute as @e[name=vpol1,tag=vil] at @s unless entity @e[type=villager,distance=0..49] if entity @e[name=village,tag=vil,scores={vpol=0..0}] run scoreboard players set @e[name=village,tag=vil] vpol1 1
execute as @e[name=vpol2,tag=vil] at @s unless entity @e[type=villager,distance=0..49] if entity @e[name=village,tag=vil,scores={vpol=0..0}] run scoreboard players set @e[name=village,tag=vil] vpol2 1
execute as @e[name=vpol3,tag=vil] at @s unless entity @e[type=villager,distance=0..49] if entity @e[name=village,tag=vil,scores={vpol=0..0}] run scoreboard players set @e[name=village,tag=vil] vpol3 1
execute as @e[name=vpol4,tag=vil] at @s unless entity @e[type=villager,distance=0..49] if entity @e[name=village,tag=vil,scores={vpol=0..0}] run scoreboard players set @e[name=village,tag=vil] vpol4 1
execute as @e[name=village,tag=vil] run function minecraft_alive_strpd:data/world/functions/village/village_/14
...
execute as @e[name=vt1,tag=vil] run function minecraft_alive_strpd:data/world/functions/village/village_/19
execute as @e[name=vt2,tag=vil] run function minecraft_alive_strpd:data/world/functions/village/village_/20
execute as @e[name=vt3,tag=vil] run function minecraft_alive_strpd:data/world/functions/village/village_/21
execute as @e[name=vt4,tag=vil] run function minecraft_alive_strpd:data/world/functions/village/village_/22
execute as @e[name=village,tag=vil] run function minecraft_alive_strpd:data/world/functions/village/village_/23
execute as @e[name=Builder_vt1n] at @s unless block ~ ~ ~ air run tp @s ~ ~1 ~
execute as @e[name=Builder_vt1p] at @s unless block ~ ~ ~ air run tp @s ~ ~1 ~
execute as @e[name=Builder_vt2n] at @s unless block ~ ~ ~ air run tp @s ~ ~1 ~
execute as @e[name=Builder_vt2p] at @s unless block ~ ~ ~ air run tp @s ~ ~1 ~
execute as @e[name=Builder_vt3n] at @s unless block ~ ~ ~ air run tp @s ~ ~1 ~
execute as @e[name=Builder_vt3p] at @s unless block ~ ~ ~ air run tp @s ~ ~1 ~
execute as @e[name=Builder_vt4n] at @s unless block ~ ~ ~ air run tp @s ~ ~1 ~
execute as @e[name=Builder_vt4p] at @s unless block ~ ~ ~ air run tp @s ~ ~1 ~
scoreboard players add @a vreg 1
execute as @a[scores={vreg=40..40}] run scoreboard players set @s vreg 0
execute as @e[name=Builder_vt1n] run function minecraft_alive_strpd:data/world/functions/village/village_/34
execute as @e[name=Builder_vt1p] run function minecraft_alive_strpd:data/world/functions/village/village_/35
execute as @e[name=Builder_vt2n] run function minecraft_alive_strpd:data/world/functions/village/village_/36
execute as @e[name=Builder_vt2p] run function minecraft_alive_strpd:data/world/functions/village/village_/37
execute as @e[name=Builder_vt3n] run function minecraft_alive_strpd:data/world/functions/village/village_/38
execute as @e[name=Builder_vt3p] run function minecraft_alive_strpd:data/world/functions/village/village_/39
execute as @e[name=Builder_vt4n] run function minecraft_alive_strpd:data/world/functions/village/village_/40
execute as @e[name=Builder_vt4p] run function minecraft_alive_strpd:data/world/functions/village/village_/41
function minecraft_alive_strpd:data/world/functions/village/village_/42
...
execute as @e[type=villager,tag=!vil,scores={vwl=1..1}] run function minecraft_alive_strpd:data/world/functions/village/village_/44
execute if entity @a[scores={vreg=29..29}] run scoreboard players add @e[type=villager,tag=!vil,scores={vwl=2..2}] vwlt 1
function minecraft_alive_strpd:data/world/functions/village/village_/46
...
execute as @e[type=villager,tag=!vil,scores={vwl=2..2,vwlt=93..93}] run function minecraft_alive_strpd:data/world/functions/village/village_/97
...
execute as @e[name=village,tag=vol] run function minecraft_alive_strpd:data/world/functions/village/village_/100
