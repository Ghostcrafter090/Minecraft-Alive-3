...
execute at @e[tag=blight,limit=1,sort=random] run function minecraft_alive_strpd:data/world/functions/blight/main_/1
function minecraft_alive_strpd:data/world/functions/blight/main_/2
...
execute at @e[name=derp,scores={randoblight=5..5}] run function minecraft_alive_strpd:data/world/functions/blight/main_/7
...
execute as @e[name=derp] run function minecraft_alive_strpd:data/world/functions/blight/main_/13
...
execute at @e[name=derp] run function minecraft_alive_strpd:data/world/functions/blight/main_/16
execute as @a run function minecraft_alive_strpd:data/world/functions/blight/main_/17
execute at @e[tag=blight] run function minecraft_alive_strpd:data/world/functions/blight/main_/18