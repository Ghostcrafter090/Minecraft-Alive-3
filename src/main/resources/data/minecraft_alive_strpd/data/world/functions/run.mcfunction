...
execute if entity @a[scores={path=25..25}] as @e[type=!item] unless entity @s[type=armor_stand] at @s run fill ~ ~-1 ~ ~ ~-1 ~ dirt replace grass_block
execute if entity @a[scores={path=24..24}] as @e[type=!item] unless entity @s[type=armor_stand] at @s run fill ~ ~-1 ~ ~ ~-1 ~ farmland replace dirt
