...
execute as @a[scores={createwaygate=0..0}] at @s run summon armor_stand ~ 255 ~ {CustomNameVisible:0b,NoGravity:1b,Silent:1b,Invulnerable:1b,PersistenceRequired:1b,CustomName:'{"text":"waygate"}'}
