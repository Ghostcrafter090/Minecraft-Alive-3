execute if entity @a[scores={reguz=4..4}] as @e[type=drowned,limit=3,sort=random] unless entity @s[scores={DB=1..1}] run scoreboard players set @s DB 1
...
execute if entity @a[scores={reguz=3..4}] as @e[type=drowned,limit=3,sort=random] run scoreboard players add @s poi_max_tier 1
execute if entity @a[scores={reguz=3..4}] as @e[type=drowned,limit=3,sort=random,scores={with_minact_tier=2..}] run scoreboard players set @s with_minact_tier 1
...
execute if entity @a[scores={reguz=3..4}] as @e[type=drowned,limit=3,sort=random] run scoreboard players add @s with_boolean 1
execute if entity @a[scores={reguz=3..4}] as @e[type=drowned,limit=3,sort=random,scores={with_max_tier=2..}] run scoreboard players set @s with_max_tier 1
