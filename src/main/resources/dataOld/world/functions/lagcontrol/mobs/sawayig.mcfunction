...
execute if entity @e[name=dmain,scores={sawayig_ent=1..}] if entity @e[name=dmain,type=marker,scores={logMcaDebug=1..1}] run say [Minecraft Alive] - Max Sawayig's detected. Clearing...